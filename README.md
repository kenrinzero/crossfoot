...
**180 transcription units shipped**. Treasury MTS May 2026 (Tables 1-9), the
...
is the live dispatch family; #161–180 are source-compared and strict-GREEN,
and #180 now awaits its required different-agent audit before #181 can ship.
