...
| treasury-mts/2026-05-outlays-legislative | `sources/treasury-mts/mts-202605.pdf` | Table 5 — Outlays, **flagship** Legislative Branch section (page 10; full 9-column model). Sets the Table-5 extraction pattern — see `plans/treasury-mts-2026-05-outlays-table5.md` | 14 | sum | ≤ 120 cells (≈96 sized) | 0 | READY (D2, first-of-family, PDF → vision agent) — planned 2026-07-14; `(**)` omitted like `......`, tolerances quote the MTS "Details may not add to totals due to rounding" note |
...
| treasury-mts/2026-05-outlays | see plan | **SIZED 2026-07-14** — Table 5 (pages 10–23) is ~4,247 cells / 662 rows / 29 sections, 9-column model → ~35–45 units at full-9 (`plans/treasury-mts-2026-05-outlays-table5.md`). Flagship `-legislative` promoted to Sized units above (D2). Remaining 28 sections (16 over-cap → sub-split by bureau) + a capstone grand-total unit are deferred pending post-flagship reassess with Kenrin. |
