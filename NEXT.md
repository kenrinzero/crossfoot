...
- 2026-09-16 · **treasury-mts August 2026 batch #451–#455 (5 units)** — labor-bureaus (86c/15r = floor, same shape as July), labor-departmental capstone (102c/16r = floor, one above July's 14 — Proprietary This-Month newly printed makes the col-2 roll-up two-source; ties-siblings 6 cells byte-match #451), state (93c/15r = floor, 3 Andean standalones = waiver; Andean Counterdrug all-omitted dropped; International Organizations This-Month newly printed 6/6 joins the departmental roll-ups; **p16 footnote-glue render-resolved**: text layer's `25,749` is footnote 2's superscript glued onto 5,749), transportation-bureaus (102c/17r = floor, two above July's 28 — FAA Other This-Month Applicable prints 22, restoring both FAA This-Month net identities; spans pp16-17), transportation-departmental capstone (95c/14r = floor, one above July's 19 — Intrabudgetary Other This-Month newly printed; 6 FRA-Other standalones = waiver; ties-siblings 21 cells byte-match #454; spans pp16-17). All strict-default GREEN 0 warnings; max tol 3 on the 10–12-component Transportation grand roll-ups; sweep 455/455; pytest 12/12. Roles graph-consistent (audit-U1 defect class not replicated). 46 August-MTS units remain. Next audit #460.
